...
class TestAbs(TestCase):
    ...
    def test_minus_max_corner(self):
        t = AssemblyTest(self, "abs.s")
...
class TestRelu(TestCase):
    def test_simple(self):
        ...
        t.call("relu")
        t.check_array(array0, [1, 0, 3, 0, 5, 0, 7, 0, 9, 10])
        t.execute()

    def test_all_zero(self):
        t = AssemblyTest(self, "relu.s")
        array1 = t.array([0, 0, 0, 0, 0])
        t.input_array("a0", array1)
        t.input_scalar("a1", len(array1))
        t.call("relu")
        t.check_array(array1, [0, 0, 0, 0, 0])
        t.execute()

    def test_hard(self):
        t = AssemblyTest(self, "relu.s")
        array0 = t.array([-0, 2147483647, -2147483647, -2147483648, 2147483648, 1073741824, -1073741824])
        t.input_array("a0", array0)
        t.input_scalar("a1", len(array0))
        t.call("relu")
        t.check_array(array0, [0, 2147483647, 0, 0, 0, 1073741824, 0])
        t.execute()
...
class TestMain(TestCase):
    ...
    def test2(self):
        self.run_main("inputs/simple2/bin", "0", "7")
