...
main:
    ...
    # load the address of the function in question into a1
    la a1, square # function pointer
...
map:
    ...
    # Remember that each node is 8 bytes long:
    # 4 for the value; 4 for the pointer to next.

    # load the value of the current node into a0
    lw a0, 0(s0) # pass argument for `square`
    ...
    add a1, s1, x0 # a0 is node address
